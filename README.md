...
- This Rating Section just works on the Web Client
- Big thanks to @n00bcoder for the Jellyfin ratings codebase (https://github.com/n00bcodr/Jellyfin-Enhanced)
...
## Installation
 ...
 3. Change the values in line 16-24 to your needs

 4. Paste modified Reviews.js inside /system/dashboard-ui/ (Windows) or your OS equivalent
 
 5. Add ```<script src="Reviews.js" defer></script>``` before ```</body>``` tag at the end of /system/dashboard-ui/index.html
